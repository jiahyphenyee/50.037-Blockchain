from TransactionsAndMerkleTree import MerkleTree, Transaction
...
class Block:
    ...
    def compute_hash(self):
        ...
        into JSON string.
        """
        d = {'index': self.index, 'transactions': self.transactions, 'timestamp': self.timestamp,
             'previous_hash': self.previous_hash}
        block_string = json.dumps(d)  # The string equivalent also considers the previous_hash field now
